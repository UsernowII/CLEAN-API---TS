import { SignUpController } from "../../../src/presentation/controllers/SingUp"
...
describe('SignUp Controller', () => {
  ...
  test('Should return 400 if no confirmation passsword is provided', () => {
    const { sut } = makeSut();
    const httpRequest = {
        body : {
            name: "any_name",
  ...
  test('Should return 400 if an invalid emaiil is provided', () => {
